...
{
    class VisitTechnicalSpecialistAccountItemTravelValidationService : IVisitTechnicalSpecialistAccountItemTravelValidationService
    {
        ...
        public VisitTechnicalSpecialistAccountItemTravelValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "VisitTechSpecItemTravelAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "VisitTechSpecItemTravelUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "VisitTechSpecItemTravelDelete.json");
            else
