...
{
    class VisitTechnicalSpecialistAccountItemTimeValidationService : IVisitTechnicalSpecialistAccountItemTimeValidationService
    {
        ...
        public VisitTechnicalSpecialistAccountItemTimeValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "VisitTechSpecItemTimeAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "VisitTechSpecItemTimeUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "VisitTechSpecItemTimeDelete.json");
            else
