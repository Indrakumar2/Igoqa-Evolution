...
{
    public class VisitTechnicalSpecialistAccountItemConsumableValidationService : IVisitTechnicalSpecialistAccountItemConsumableValidationService
    {
        ...
        public VisitTechnicalSpecialistAccountItemConsumableValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "VisitTechSpecItemConsumableAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "VisitTechSpecItemConsumableUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "VisitTechSpecItemConsumabledelete.json");
            else
