...
{
    public class VisitNoteValidationService : IVisitNoteValidationService
    {
        ...
        public VisitNoteValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "VisitNoteAdd.json");
            else
