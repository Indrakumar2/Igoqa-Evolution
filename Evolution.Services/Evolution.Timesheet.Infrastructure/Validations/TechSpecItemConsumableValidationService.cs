...
{
    public class TechSpecItemConsumableValidationService :ITechSpecItemConsumableValidationService
    {
        ...
        public TechSpecItemConsumableValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "TechSpecItemConsumableAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "TechSpecItemConsumableUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "TechSpecItemConsumableDelete.json");
            else
