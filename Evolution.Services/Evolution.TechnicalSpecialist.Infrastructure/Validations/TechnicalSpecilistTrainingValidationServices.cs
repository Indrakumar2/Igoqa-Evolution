...
{
    public class TechnicalSpecilistTrainingValidationServices : ITechnicalSpecialistTrainingValidationService
    {
        ...
        public TechnicalSpecilistTrainingValidationServices(IValidationService validation) { this._validation = validation; }
