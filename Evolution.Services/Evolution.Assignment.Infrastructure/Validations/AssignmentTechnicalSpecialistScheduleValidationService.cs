...
{
    public class AssignmentTechnicalSpecialistScheduleValidationService : IAssignmentTechnicalSpecialistScheduleValidationService
    {
        ...
        public AssignmentTechnicalSpecialistScheduleValidationService(IValidationService validation) { this._validation = validation; }
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "AssignmentTechnicalSpecialistScheduleAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "AssignmentTechnicalSpecialistScheduleUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "AssignmentTechnicalSpecialistScheduleDelete.json");
            else
