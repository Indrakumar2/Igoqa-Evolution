...
{
    public class AssignmentContributionCalculationValidationService : IAssignmentContributionCalculationValidationService
    {
        ...
        public AssignmentContributionCalculationValidationService(IValidationService validation) { this._validation = validation; }
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "AssignmentContributionCalculationAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "AssignmentContributionCalculationUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "AssignmentContributionCalculationDelete.json");
            else
