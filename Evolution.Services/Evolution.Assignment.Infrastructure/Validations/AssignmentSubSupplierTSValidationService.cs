...
{
    public class AssignmentSubSupplierTSValidationService : IAssignmentSubSupplierTSValidationService
    {
        ...
        public AssignmentSubSupplierTSValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "AssignmentSubSupplierTSAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "AssignmentSubSupplierTSUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "AssignmentSubSupplierTSDelete.json");
            else
