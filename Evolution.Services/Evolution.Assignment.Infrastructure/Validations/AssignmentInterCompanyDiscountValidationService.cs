...
{
    public class AssignmentInterCompanyDiscountValidationService : IAssignmentInterCompanyDiscountValidationService
    {
        ...
        public AssignmentInterCompanyDiscountValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "AssignmentInterCompanyDiscountAdd.json");
            else if (type == ValidationType.Update)
                basePath = Path.Combine(basePath, "Update", "AssignmentInterCompanyDiscountUpdate.json");
            else if (type == ValidationType.Delete)
                basePath = Path.Combine(basePath, "Delete", "AssignmentInterCompanyDiscountDelete.json");
            else
