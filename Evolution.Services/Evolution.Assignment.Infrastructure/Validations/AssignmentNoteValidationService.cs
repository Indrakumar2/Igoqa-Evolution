...
{
    public  class AssignmentNoteValidationService: IAssignmentNoteValidationService
    {
        ...
        public AssignmentNoteValidationService(IValidationService validation)
        {
        ...
        public IList<JsonPayloadValidationResult> Validate(string jsonModel, ValidationType type)
        {
            ...
            if (type == ValidationType.Add)
                basePath = Path.Combine(basePath, "Save", "AssignmentNoteAdd.json");
