...
namespace Evolution.Admin.Api.Controllers.Admin
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public Response GetCoordinators([FromBody] CoordinatorParams coordinatorParams)
        {
            ...
            try
            {
                return _service.GetByUserType(coordinatorParams.CompanyCode, coordinatorParams.UserTypes,
                    coordinatorParams.IsActiveCoordinators);
            }
            catch (Exception ex)
            {
                exception = ex;
        ...
        public Response ReportCoordinators([FromBody] CoordinatorParams coordinatorParams)
        {
            ...
            try
            {
                return _service.GetByUserType(coordinatorParams.CompanyCodes, coordinatorParams.UserTypes,
                    coordinatorParams.IsActiveCoordinators);
            }
            catch (Exception ex)
            {
        ...
        public Response GetReportCoordniators([FromBody] ReportCoordinatorParams reportCoordinatorParams)
        {
            ...
            try
            {
                return _service.GetReportCoordniators(reportCoordinatorParams.CompanyCode,
                    reportCoordinatorParams.IsVisit, reportCoordinatorParams.IsOperating);
            }
            catch (Exception ex)
            {
                exception = ex;
