...
namespace Evolution.Api.Controllers.Master
{
    ...
    {
        private readonly ITaxonomySubCategoryService _service = null;
        private readonly IAppLogger<TaxonomySubCategoryController> _logger = null;

        public TaxonomySubCategoryController(ITaxonomySubCategoryService service,IAppLogger<TaxonomySubCategoryController> logger)
        {
