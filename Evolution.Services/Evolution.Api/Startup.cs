...
namespace Evolution.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var registration = new ServiceRegistration(Configuration,null, ServiceCollection);  
            ...
            registration.RegisterAutoMapperProfile(); //Automapper Registration
        ...
        {
            var registration = new ServiceRegistration(Configuration,loggerFactory, ServiceCollection);
